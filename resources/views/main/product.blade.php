            ...
            <div class="col-xl-5 col-lg-5 col-md-6">
                <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item"> <img class="d-block w-100" src="{{ asset('storage/'.$product->image2) }}" alt="Second slide"> </div>
                        <div class="carousel-item"> <img class="d-block w-100" src="{{ asset('storage/'.$product->image3) }}" alt="Third slide"> </div>
                    </div>
                    ...
                    <ol class="carousel-indicators">
                        <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                            <img class="d-block w-100 img-fluid" src="{{ asset('storage/'.$product->image) }}" alt="" />
                        </li>
                        <li data-target="#carousel-example-1" data-slide-to="1">
                            <img class="d-block w-100 img-fluid" src="{{ asset('storage/'.$product->image2) }}" alt="" />
                        </li>
                        <li data-target="#carousel-example-1" data-slide-to="2">
                            <img class="d-block w-100 img-fluid" src="{{ asset('storage/'.$product->image3) }}" alt="" />
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row my-5">
            <div class="col-lg-12">
                ...
                <div class="featured-products-box owl-carousel owl-theme">
                    @foreach ($mal_products as $product)
                    <div class="item">
