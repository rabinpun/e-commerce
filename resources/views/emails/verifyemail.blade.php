...
<td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                        <h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">This is a verification email for your account registered in our ecommerce website.</h1>
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">To verify your email address. Click the link below<br><a  href={{$verificationUrl}} style="border:1px solid black;border-radius:5px;background-color:rgb(214, 57, 57);height:4rem;width:10rem;color:white;text-decoration:none">Click here</a></p>
<h5 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 16px; font-weight: bold; margin-top: 0; text-align: left;"> </h5>
